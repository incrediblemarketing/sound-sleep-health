...
gulp.task('copy', function() {
	...
	var gsap = gulp.src('./assets/src/js/gsap/**/*').pipe(gulp.dest('./assets/dist/plugins/gsap'));
	return merge(modernizr, fontawesomecss, fontawesomejs, fontawesomewebfonts, swiper, bootstrap, scrollmagic);
});
